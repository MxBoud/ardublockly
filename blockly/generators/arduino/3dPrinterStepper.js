...
goog.provide('Blockly.Arduino.3dPrinterStepper');
 ...
 */
Blockly.Arduino['3dPrinterStepper'] = function(block) {
  var stepperName = block.getFieldValue('STEPPER_NAME');
  var setupCode = stepperName + '.setSpeed(' + '100' + ');';
  Blockly.Arduino.addSetup(stepperName, setupCode, true);
  var stepperCodeL1 = 'void myStepper_step(int stepPin,int dirPin,int dir,int numStep, int sDelay){';
  var stepperCodeL2 = 'thisisline2';

  Blockly.Arduino.addDeclaration('stepperTagL1',stepperCodeL1);
  Blockly.Arduino.addDeclaration('stepperTagL2',stepperCodeL2);
